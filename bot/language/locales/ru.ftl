...
file-mkdir-description = Правила создания папки вместе с описанием файла.
...
file-upload-description = Правила загрузки файлов вместе с описанием файла.
...
file-upload-stop = Загрузка файлов прекращена.
...
## Ошибки
not_author = Вы не можете использовать эти кнопки.
msg_is_inaccessible = Это сообщение недоступно.